...
```sh
kubectl apply -f https://raw.githubusercontent.com/Levalicious/kube-static-egress-ip/master/config/static-egressip-crd.yaml
```

Create necessary RBAC to run the controllers

```sh
kubectl apply -f https://raw.githubusercontent.com/Levalicious/kube-static-egress-ip/master/config/static-egressip-rbac.yaml
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/Levalicious/kube-static-egress-ip/master/config/static-egressip-gateway-manager.yaml
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/Levalicious/kube-static-egress-ip/master/config/static-egressip-controller.yaml
```
